...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript" >
        function ParentRefrash() {
            return document.getElementById('<%=hdnUpdateCount.ClientID %>');
        }
    </script>

    <asp:HiddenField ID="hdnUpdateCount" runat="server" />
            ...
            <div class="card card-primary">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <label class="form-label">Stusent Name</label>
                        ...
                        <div class="col-md-4">
                            <div class="form-group ">
                                ...
                                <asp:DropDownList ID="ddlDistrict" runat="server" OnSelectedIndexChanged="ddlDistrict_SelectedIndexChanged" AutoPostBack="true" CssClass="form-control"></asp:DropDownList>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group ">
                        ...
                        <div class="col-md-4 "><br />
                            ...
                            <asp:Button ID="btnSearch" CssClass="btn btn-secondary" runat="server" Text="Search" OnClick="btnSearch_Click" />
                        </div>
                    </div>
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField>
                                            ...
                                            <ItemTemplate>
                                                ...
                                                <asp:LinkButton ID="lblAdCancel" runat="server" CommandName="adcancel" CommandArgument="<%# Container.DataItemIndex %>" >Admission Cancel</asp:LinkButton>
                                            </ItemTemplate>
                                        </asp:TemplateField>

...
namespace DAL
{
    public class StudentProfileDAL
    {
        ...
        public int InsertAdmission(Entity.EStudentProfile objEStuP)
        {
            ...
            DbCommand dbcmd;
            db = DatabaseFactory.CreateDatabase("cnn");
            dbcmd = db.GetStoredProcCommand("Admission_SpInsert");
        ...
        public DataTable StudentListforAddmission(string StuName, int District,int Upazila,string ContactNo)
        {
            DataTable dt = new DataTable();
            Database db;
            DbCommand dbcmd;
            db = DatabaseFactory.CreateDatabase("cnn");
            dbcmd = db.GetStoredProcCommand("GetStudentList_SpAddmission");

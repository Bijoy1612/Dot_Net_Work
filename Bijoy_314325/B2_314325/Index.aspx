<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="B2_314325.Index" %>
...
<form id="form1" runat="server">
    ...
    <section id="footer">
        <div class="container-fluid bg-dark text-center p-2">
            <p>&copy; <a href="https://www.google.com/" target="_blank">Copyright @ Bijoy Basak</a></p>
        </div>
    </section>
    <!--/Footer Bottom-->
